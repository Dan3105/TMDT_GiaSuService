...
namespace GiaSuService.Services.Interface
{
    public interface IAuthService
    {
        ...
        public Task<bool> CreateTutorRegisterRequest(Account account, Tutorprofile tutorprofile, IEnumerable<int> districtId, IEnumerable<int> gradeId, IEnumerable<int> subjectId,
